...
use crate::{
    engine::piece::*,
    gui::assets::{
        BB_BYTES, BLACK_BISHOP_TEXTURE_ID, BLACK_KNIGHT_TEXTURE_ID, BLACK_QUEEN_TEXTURE_ID,
        BLACK_ROOK_TEXTURE_ID, BN_BYTES, BQ_BYTES, BR_BYTES, NEW_BLACK_BYTES, NEW_BLACK_TEXTURE_ID,
        NEW_WHITE_BYTES, NEW_WHITE_TEXTURE_ID, WB_BYTES, WHITE_BISHOP_TEXTURE_ID,
        WHITE_KNIGHT_TEXTURE_ID, WHITE_QUEEN_TEXTURE_ID, WHITE_ROOK_TEXTURE_ID, WN_BYTES, WQ_BYTES,
        WR_BYTES,
    },
};
