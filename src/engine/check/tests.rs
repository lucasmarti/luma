...
fn test_bishop_check() {
    ...
    position = position
        .put_piece(Piece::WHITE_KING, E1)
        .put_piece(Piece::BLACK_KING, E8)
        .put_piece(Piece::BLACK_BISHOP, H4);
...
fn test_queen_check_diagonal() {
    ...
    position = position
        .put_piece(Piece::WHITE_KING, E1)
        .put_piece(Piece::BLACK_KING, E8)
        .put_piece(Piece::BLACK_QUEEN, A5);
...
fn test_queen_check_horizontal() {
    ...
    position = position
        .put_piece(Piece::WHITE_KING, E1)
        .put_piece(Piece::BLACK_KING, E8)
        .put_piece(Piece::BLACK_QUEEN, E5);
...
fn test_knight_check() {
    ...
    position = position
        .put_piece(Piece::WHITE_KING, E1)
        .put_piece(Piece::BLACK_KING, E8)
        .put_piece(Piece::BLACK_KNIGHT, D3);
...
fn test_pawn_check_white() {
    let mut position = Position::default();
    position = position
        .put_piece(Piece::BLACK_KING, E4)
        .put_piece(Piece::WHITE_KING, E1)
        .put_piece(Piece::WHITE_PAWN, D3);
...
fn test_blocked_bishop_no_check() {
    ...
    position = position
        ...
        .put_piece(Piece::BLACK_KING, E8)
        .put_piece(Piece::BLACK_BISHOP, H4)
        .put_piece(Piece::WHITE_KNIGHT, F2);
