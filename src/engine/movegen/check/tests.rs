use super::*;
use crate::engine::{movegen::*, piece::*, position::Position};
...
fn test_pawn_check_white() {
    let mut position = Position::default();
    position = position
        .with_piece(BLACK_KING, E4)
        .with_piece(WHITE_KING, E1)
        .with_piece(WHITE_PAWN, D3);
